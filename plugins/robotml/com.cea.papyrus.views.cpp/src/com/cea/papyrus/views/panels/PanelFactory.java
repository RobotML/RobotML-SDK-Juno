...
public class PanelFactory {
	 ...
	 * @param parent the composite parent for the new panel
	 * @param style the SWT style of the panel
	 * @param object the object for which the panel is created
	 ...
	 * @param parent the composite parent for the new panel
	 * @param style the SWT style of the panel
	 * @param element the UML2 element for which the panel is created
	 * @return the newly created panel
	 */
